...
text = re.sub(r'\[data-theme="dark"\] \.p-name \{ color: #\w+; \}', '[data-theme="dark"] .p-name { color: #ffffff; }', text)
text = re.sub(r'\[data-theme="dark"\] \.p-meta \{ color: #\w+; \}', '[data-theme="dark"] .p-meta { color: #adb5bd; }', text)
