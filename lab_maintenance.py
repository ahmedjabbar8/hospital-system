...
def lab_maintenance():
    ...
    <style>
        ...
        [data-theme="dark"] .glass-header { background: rgba(26, 11, 29, 0.4); backdrop-filter: blur(15px); -webkit-backdrop-filter: blur(15px); }
        ...
        [data-theme="dark"] .icon-orb { box-shadow: 0 0 20px rgba(208, 122, 251, 0.4); }
        ...
        [data-theme="dark"] .premium-row:hover { background: rgba(255,255,255,0.03) !important; }
        ...
        [data-theme="dark"] .test-name { color: var(--text); }
        ...
        [data-theme="dark"] .price-val-container {
            background: rgba(var(--primary-rgb), 0.1) !important;
...
def lab_form():
    ...
    <style>
        ...
        [data-theme="dark"] .shadow-apple { box-shadow: 0 10px 40px rgba(0,0,0,0.4) !important; }
    </style>
    """ + footer_html
