header_html = r"""
<!DOCTYPE html>
<html lang="{{ session.get('lang', 'ar') }}" dir="{{ 'rtl' if session.get('lang', 'ar') == 'ar' else 'ltr' }}" data-theme="{{ 'dark' if session.get('theme') == 'dark' else 'light' }}">
...
<head>
    ...
    <style>
        ...
        [data-theme='dark'] {
            ...
            --ui-gray: rgba(255, 255, 255, 0.06);
            --ui-row-hover: rgba(255, 255, 255, 0.035);
        ...
        [data-theme='dark'] .apple-nav { background: rgba(26, 11, 29, 0.8) !important; }
        ...
        [data-theme='dark'] .mock-table th { background: rgba(255,255,255,0.03); }
...
<body>
    ...
    <div class="apple-nav no-print shadow-sm d-flex align-items-center px-3 justify-content-between">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <!-- Theme Toggle -->
            <div onclick="toggleTheme()" style="cursor:pointer;" class="p-2" id="theme-btn" title="{{ 'تغيير المظهر' if session.get('lang', 'ar') == 'ar' else 'Toggle Theme' }}">
    ...
    <script>
        ...
        setInterval(() => {
            ...
            const timeStr = lang == 'ar' ? toArabicDigits(`${hours}:${minutes}`) : `${hours}:${minutes}`;
