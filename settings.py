...
def view_settings():
    ...
    <!-- Programmer Permissions Section -->
    <div class="row pt-2 mb-4 text-center mt-3">
        <div class="col-12">
            <h3 class="fw-bold text-danger mb-0"><i class="fas fa-laptop-code me-2"></i>صلاحيات المبرمج</h3>
            <p class="text-muted small">إعدادات متقدمة وخاصة بتطوير وتحديث النظام</p>
        </div>
    </div>
    <div class="row row-cols-2 row-cols-md-4 g-3 justify-content-center mb-5">
        <div class="col">
            <a href="{{ url_for('programmer_settings.change_name') }}" class="neo-tile tile-red" style="border: 2px dashed #dc3545;">
                <i class="fas fa-signature text-danger"></i>
                <span>تغيير اسم النظام</span>
            </a>
        </div>
        <div class="col">
            <a href="{{ url_for('programmer_settings.update_system') }}" class="neo-tile tile-orange" style="border: 2px dashed #fd7e14;">
                <i class="fas fa-sync-alt text-warning"></i>
                <span>تحديث النظام</span>
            </a>
        </div>
        <div class="col">
            <a href="{{ url_for('programmer_settings.system_access') }}" class="neo-tile tile-dark" style="border: 2px dashed #6c757d;">
                <i class="fas fa-user-shield text-secondary"></i>
                <span>الدخول للنظام</span>
            </a>
        </div>
        <div class="col">
            <a href="{{ url_for('programmer_settings.activate_system') }}" class="neo-tile tile-green" style="border: 2px dashed #28a745;">
                <i class="fas fa-key text-success"></i>
                <span>تفعيل النظام</span>
            </a>
        </div>
        <div class="col">
            <a href="{{ url_for('programmer_settings.reset_data') }}" class="neo-tile tile-red" style="border: 2px dashed #dc3545;">
                <i class="fas fa-eraser text-danger"></i>
                <span class="text-danger">تفريغ بيانات المرضى</span>
            </a>
        </div>
    </div>
    """ + footer_html
