    ...
    <div class="pf-body pt-4">
        <div class="container-fluid px-lg-5">
            ...
            <style>
                ...
                [data-theme='dark'] .ptile.c-blue   .ptile-icon-wrap { color: #0a84ff; background: rgba(10,132,255,0.15); }
                [data-theme='dark'] .ptile.c-green  .ptile-icon-wrap { color: #30d158; background: rgba(48,209,88,0.15); }
                [data-theme='dark'] .ptile.c-orange .ptile-icon-wrap { color: #ff9f0a; background: rgba(255,159,10,0.15); }
                [data-theme='dark'] .ptile.c-red    .ptile-icon-wrap { color: #ff453a; background: rgba(255,69,58,0.15); }
                [data-theme='dark'] .ptile.c-purple .ptile-icon-wrap { color: #bf5af2; background: rgba(191,90,242,0.15); }
            ...
            <div class="ptile-row animate-fade" style="animation-delay:0.1s;">
                ...
                <div onclick="showSection('reports-section')" class="ptile c-purple">
                    ...
                    <div class="ptile-label">التقارير</div>
                    <div class="ptile-sublabel">Reports</div>
                </div>
            ...
            <div class="animate-fade" style="animation-delay: 0.2s;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="badge bg-light text-dark border px-3" style="background: var(--pf-input-bg) !important; color: var(--pf-text) !important;">
                                            ...
                                            {% if h.created_at and h.created_at.__class__.__name__ == 'datetime' %}
                                                {{ h.created_at.strftime('%Y-%m-%d  %I:%M %p') }}
                                            {% else %}
                ...
                <div class="section-content" id="reports-section" style="display: none;">
                    ...
                    <style>
                        ...
                        [data-theme='dark'] .rep-section-card {
                        ...
                        [data-theme='dark'] .rep-card-header { border-color: rgba(255,255,255,0.07); }
                        ...
                        [data-theme='dark'] .rep-count-pill.rx { color: #30d158; }
                        [data-theme='dark'] .rep-count-pill.lab { color: #0a84ff; }
                        ...
                        [data-theme='dark'] .pro-table thead th { background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.07); }

                        .pro-table tbody tr {
                            transition: background 0.2s;
                            border-bottom: 1px solid var(--pf-border);
                        }
                        [data-theme='dark'] .pro-table tbody tr { border-color: rgba(255,255,255,0.05); }
                        .pro-table tbody tr:last-child { border-bottom: none; }
                        .pro-table tbody tr:hover { background: rgba(0,0,0,0.015); }
                        [data-theme='dark'] .pro-table tbody tr:hover { background: rgba(255,255,255,0.03); }
                        ...
                        [data-theme='dark'] .count-bubble { color: #0a84ff; }
                        ...
                        [data-theme='dark'] .btn-action-rx { color: #30d158; }
                        [data-theme='dark'] .btn-action-rx:hover { color: #30d158; }
                        ...
                        [data-theme='dark'] .btn-action-lab { color: #0a84ff; }
                        [data-theme='dark'] .btn-action-lab:hover { color: #0a84ff; }
                        ...
                        [data-theme='dark'] .btn-action-view { color: #9d9bff; border-color: rgba(157,155,255,0.4); background: rgba(157,155,255,0.08); }
                        ...
                        [data-theme='dark'] .btn-action-whatsapp { color: #25d366; border-color: rgba(37, 211, 102, 0.4); background: rgba(37, 211, 102, 0.08); }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="date-badge">
                                                ...
                                                {{ pr.created_at.strftime('%Y-%m-%d') if pr.created_at.__class__.__name__ == 'datetime' else pr.created_at }}
                                            </div>
                                            {% if pr.created_at.__class__.__name__ == 'datetime' %}
                                            <div style="font-size:0.72rem;opacity:0.45;margin-top:4px;padding-right:4px;">
                                                <i class="fas fa-clock me-1"></i>{{ pr.created_at.strftime('%H:%M') }}
                                            </div>
                                            {% endif %}
                                        </td>
                                        <td>
                                            <div class="med-name-cell">
                                                <div class="med-main">{{ pr.medicine_name|replace('\\n', ' — ')|safe | truncate(60) }}</div>
                                            </div>
                                        </td>
                                        <td style="text-align:center;">
                                            <div class="d-flex gap-2 justify-content-center flex-wrap">
                                                <a href="{{ url_for('print_rx.print_rx', prescription_id=pr.prescription_id) }}" target="_blank" class="btn-action-rx" title="طباعة الوصفة">
                                                    <i class="fas fa-print"></i> طباعة
                                                </a>
                                                <a href="{{ url_for('print_rx.print_rx', prescription_id=pr.prescription_id) }}" target="_blank" class="btn-action-view" title="عرض الوصفة">
                                                    <i class="fas fa-eye"></i> عرض
                                                </a>
                                                 <a href="javascript:void(0)" onclick="robustShare('{{ url_for('print_rx.print_rx', prescription_id=pr.prescription_id) }}', 'وصفة طبية - {{ p.full_name_ar }}', '{{ p.phone1 }}')" class="btn-action-whatsapp" title="إرسال ملف PDF عبر واتساب">
                    ...
                    <div class="rep-section-card">
                        ...
                        {% set grouped_labs = {} %}
                        {% for l in labs %}
                            {% set d = l.created_at.strftime('%Y-%m-%d') if l.created_at.__class__.__name__ == 'datetime' else l.created_at[:10] %}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="date-badge">
                                                <i class="fas fa-calendar-alt"></i>
                                                {{ r.created_at.strftime('%Y-%m-%d') if r.created_at and r.created_at.__class__.__name__ == 'datetime' else r.created_at }}
                                            </div>
                                            {% if r.created_at and r.created_at.__class__.__name__ == 'datetime' %}
                                            <div style="font-size:0.72rem;opacity:0.45;margin-top:4px;padding-right:4px;">
                                                <i class="fas fa-clock me-1"></i>{{ r.created_at.strftime('%H:%M') }}
                                            </div>
                                            {% endif %}
                                        </td>
                                        <td>
                        ...
                        <div class="p-4">
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    {% for r in rads %}
                                        <tr>
                                            <td class="text-center"><small class="text-muted">{{ r.created_at.strftime('%Y-%m-%d  %I:%M %p') if r.created_at and r.created_at.__class__.__name__ == 'datetime' else r.created_at }}</small></td>
