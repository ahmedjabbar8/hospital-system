footer_html = """
    ...
    <div id="statusIndicator" class="position-fixed bottom-0 end-0 m-3 px-3 py-1 rounded-pill bg-dark text-white fw-bold shadow-lg" style="z-index:9999999; font-size:0.6rem; opacity:0.6;">
    ...
    <script>
        ...
        async function runHyperPolling() {
            while (true) {
                ...
                // No wait on success for instant feel, small delay if empty to avoid CPU spike
